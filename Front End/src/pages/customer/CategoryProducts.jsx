...
function CategoryProducts() {
    ...
    const fetchProducts = async () => {
        const response = await axios.get(`${serverUrlAPI}product/category?category=${categoryParam}`);
      ...
      <div className='px-6 md:px-16 lg:px-24 xl:px-32 mt-[60px]'>
        <div className='flex flex-col md:flex-row md:items-center md:justify-between items-center'>
          <div className='flex flex-col items-end'>
            <h1 className='text-gray-700 text-2xl font-medium capitalize'>{categoryParam} Products</h1>
  ...
  function ProductCard({ product }) {
    ...
    return (
      <div
        className="border border-gray-300 rounded-md px-4 py-3 mt-10 bg-white w-[220px] flex-shrink-0 cursor-pointer"
