...
function Login() {
  ...
  const userSignIn = async (val) => {
    const response = await axios.post(serverUrl+"auth/user/login",val);
    return response.data;
  };

  const signInMutation = useMutation({
    mutationKey: ["customer-signIn"],  // Using array for better cache management
        ...
        <Formik   // form handling & validation
            ...
            >
              {({// Destructuring Formik Props
                ...
                <Form>
                    <div className="text-2xl text-center mt-[90px] font-medium text-gray-600"><span className="text-[#4FBF8B] text-2xl">User</span> Login</div>
                     ...
                     <div className="w-full flex justify-center items-center mt-[30px]">
                      ...
                      <div className="w-full flex justify-center items-center mt-4">
                        <p className="text-[13px]">
                          ...
                          className="text-[#4FBF8B] ms-1 cursor-pointer"
